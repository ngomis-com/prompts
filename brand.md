...
*   Body Text: Fira Sans OTF Regular, 11pt
*   Heading 1: Montserrat Light, 18pt
*   Heading 2: Fira Sans OTF Book, 13pt
...
**Output:** Generate *only* the Markdown content for the Brand section based on the provided input variables.
