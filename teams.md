...
### Governing Body
*   **Achintya Ghosh:** Trustee
    *   *Bio:* {bio_short or bio_long for Achintya Ghosh}
*   **THOMAS MATHEW:** Trustee
    *   *Bio:* {bio_short or bio_long for THOMAS MATHEW}
*   **ASIF ZAIDI:** Executive Director
    *   *Bio:* {bio_short or bio_long for ASIF ZAIDI}
...
| Rudauli, Uttar Pradesh     | 10         |
| Sohna, Haryana             | 6          |
| Sonipat, Haryana           | 12         |
| **Total Strength**         | **49**     | *(Calculate if possible or state provided total)*

```

**Output:** Generate *only* the Markdown content for the Teams section based on the provided input variables.
